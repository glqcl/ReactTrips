...
var HotelListController = require('./HotelListController');
...
export default class HotelMainController extends Component<{}>
{
    ...
    searchController()
    {
        ...
        // this.props.navigation.navigate('HotelListController',{queryData:queryData});
        // this.props.navigation.navigate('SpeechController');
