...
var HMScrollImage = require('./HMScrollImage');
...
export default class HMIndex extends Component
{
    ...
    getPicList()
    {
        var imgList = [];
        var self = this;
        NetUitl.getImageList(HMServerUrl.scrollUrl, function (success)
        {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.outerViewStytle}>
                    ...
                    <View style={[styles.middleViewStytle]}>
                        <TouchableOpacity style={styles.leftViewStyle} opacity={HMCommonStyle.activeOpacity}
