	...
	if (file) {
		...
		oReader.onload = function(e) {
			...
			image.onload = function() {
				...
				if (this.naturalWidth > this.naturalHeight && this.naturalWidth > 360) {
					expectWidth = 360;
					expectHeight = expectWidth * this.naturalHeight / this.naturalWidth;
				} else if (this.naturalHeight > this.naturalWidth && this.naturalHeight > 360) {
					expectHeight = 360;
				...
				$.ajax({
				    ...
				    data:{"fileType":"3","imgBase":base64},
				    dataType: "json",
				    async:false, 
