 ...
 * @update  2015-06-08
 */
var SimPannel = function(options){
	return new SimPannel.prototype.init(options);
};
SimPannel.prototype = {
	version: '1.00',
	author: 'jzy',
	construtor: SimPannel, //修正构造函数指针
...
SimPannel.prototype.init.prototype = SimPannel.prototype;
